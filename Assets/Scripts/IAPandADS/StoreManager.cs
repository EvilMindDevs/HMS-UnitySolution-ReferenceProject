...
//                List productList = res.getProductInfoList();
//                for (int i = 0; i < productList.size(); i++)
//                {
//                    switch (Counter++)
//                    {
//                        case 0:
//                            FillProduct(product1, productList[i]);
//                            break;
//                        case 1:
//                            FillProduct(product2, productList[i]);
//                            break;
//                        case 2:
//                            FillProduct(product3, productList[i]);
//                            break;
//                    }
//                }
//            }
...
//            Debug.Log("FillProduct" + product.name + " - productInfo" + productInfo.getProductName().ToString());
//            product.SetActive(true);
//            if (product.transform.childCount > 0)
//            {
//                product.transform.GetChild(0).gameObject.GetComponent<TextMeshProUGUI>().text = productInfo.getProductName().ToString();
//                product.transform.GetChild(1).gameObject.GetComponent<TextMeshProUGUI>().text = productInfo.getProductDesc().ToString();
//                product.transform.GetChild(3).gameObject.GetComponent<TextMeshProUGUI>().text = productInfo.getPrice().ToString() + productInfo.getCurrency().ToString();
//                product.transform.GetChild(4).GetChild(0).gameObject.GetComponent<TextMeshProUGUI>().text = productInfo.getProductName().ToString();
